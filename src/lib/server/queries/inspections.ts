...
export async function getInspectionByUuid(uuid: string) {
	const rows = await db
		.select({
			...
			officerId: inspections.officerId,
			rangeId: inspections.rangeId,
			eriInspectionId: inspections.eriInspectionId,
			eriPreconditionsId: inspections.eriPreconditionsId,
			inspectorName: inspections.inspectorName,
			inspectionDate: inspections.inspectionDate,
			approxReportDate: inspections.approxReportDate,
			whenApproxReportDateProvided: inspections.whenApproxReportDateProvided,
			inspectionStatus: inspections.inspectionStatus,
			notes: inspections.notes,
			...
			dateAcquired: inspections.dateAcquired,
			approxDateAcquired: inspections.approxDateAcquired,
			lessTwelveMonthsAcquired: inspections.lessTwelveMonthsAcquired,
